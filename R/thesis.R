...
#' @param ... Additional arguments passed to bookdown proper function
#' @return A modified \code{pdf_document} based on the Reed Senior Thesis LaTeX
#'   template
#' @import bookdown
#' @examples
#' \dontrun{
#'  output: miniBeamer::thesis_pdf
#' }
...
#' @examples
#' \dontrun{
#'  output: miniBeamer::thesis_gitbook
#' }
